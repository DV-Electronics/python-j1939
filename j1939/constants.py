...
PGN_TP_CONNECTION_MANAGEMENT_PF = 0xec
PGN_TP_DATA_TRANSFER = 0xeb00
PGN_TP_DATA_TRANSFER_PF = 0xeb
PGN_TP_SEED_REQUEST = 0xd400
PGN_TP_SEED_REQUEST_PF = 0xd4

# address claim PGNs
PGN_AC_ADDRESS_CLAIMED = 0xee00
PGN_AC_ADDRESS_CLAIMED_PF = 0xee
PGN_AC_COMMANDED_ADDRESS = 0xfed8

PGN_REQUEST_FOR_PGN = 0xea00
PGN_REQUEST_FOR_PGN_PF = 0xea
...
pgn_strings = {
    ...
    PGN_TP_SEED_REQUEST: "PGN_TP_SEED_REQUEST"
}
